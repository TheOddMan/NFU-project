...
def CatchPICFromVideo(start_number=1,imagePrefix="train",imgFolder="FaceData",fileName='',
...
CatchPICFromVideo(imagePrefix="40441125_test",start_number=1,fileName='me.mov')
